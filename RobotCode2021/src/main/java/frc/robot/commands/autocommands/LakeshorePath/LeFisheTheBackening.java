...
/**
 * <h3>LeFisheTheBackening</h3>
 * 
 * This class implements another autonomous path. This path shoots three power
 * cells from the initiation line, moves to the trench to collect three more
 * power cells and finally shoots those power cells from the trench
 */
public class LeFisheTheBackening extends SequentialCommandGroup {
         ...
         * <h3>LeFisheTheBackening</h3>
         * 
         * Autonomous command to run LeFisheTheBackening path
         * 
         ...
         */
        public LeFisheTheBackening(NewDriveSubsystem dSubsystem, IntakePistonSubsystem iPistonSubsystem,
                ...
                trajectory2 = TrajectoryGenerator.generateTrajectory(
                                ...
                                new Pose2d(inchesToMeters(-160) + xOffset, inchesToMeters(-80) + yOffset,
                                                new Rotation2d(Math.toRadians(0))),
                                // Pass config
                ...
                addCommands(rollerCommand, new ExtendIntakePistonCommand(iPistonSubsystem),
                                ...
                                new StopTowerKickerCommandGroup(tSubsystem, kSubsystem), command1, // forward
                                command2, // backward
                                new AutoTurretTurnCommand(turSubsystem),
                                new ParallelRaceGroup(new WaitCommand(2), new AutoAimAutonomousCommand(lLightSubsystem,
                                                turSubsystem,
