...
/**
 * <h3>LeFisheTheFishening</h3>
 * 
 * This autonomous path implements the LeFisheTheFishening path
 * 
 */
public class LeFisheTheFishening extends SequentialCommandGroup {
         ...
         * <h3>LeFisheTheFishening</h3>
         * 
         * Autonomous command to run LeFisheTheFishening path
         * 
         ...
         */
        public LeFisheTheFishening(NewDriveSubsystem dSubsystem, IntakePistonSubsystem iPistonSubsystem,
                ...
                trajectory1 = TrajectoryGenerator.generateTrajectory(
                                ...
                                new Pose2d(inchesToMeters(140) + xOffset, inchesToMeters(65) + yOffset,
                ...
                trajectory2 = TrajectoryGenerator.generateTrajectory(
                                ...
                                List.of(new Translation2d(inchesToMeters(36) + xOffset, inchesToMeters(60) + yOffset),
                ...
                TrajectoryGenerator.generateTrajectory(
                                ...
                                new Pose2d(inchesToMeters(-76) - xOffset, inchesToMeters(38) + yOffset,
                ...
                TrajectoryGenerator.generateTrajectory(
                                // Robot starts at X: 0 Y: 0 and a rotation of 0
                                new Pose2d(0, 0, new Rotation2d(Math.toRadians(0))), List.of(),
                                new Pose2d(inchesToMeters(60) + xOffset, inchesToMeters(-76) - yOffset,
                                                new Rotation2d(Math.toRadians(0))),
                                // Pass config
                                AutonConfig.getInstance().getSlowConfigStart());
