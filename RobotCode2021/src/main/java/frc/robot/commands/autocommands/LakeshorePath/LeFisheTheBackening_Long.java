...
public class LeFisheTheBackening_Long extends SequentialCommandGroup {
        ...
        /**
         * <h3>LeFisheTheBackening_Long</h3>
         * 
         * Autonomous command to run LeFisheTheBackening_Long path
         * 
         ...
         */
        public LeFisheTheBackening_Long(NewDriveSubsystem dSubsystem, IntakePistonSubsystem iPistonSubsystem,
                ...
                trajectory2 = TrajectoryGenerator.generateTrajectory(
                                ...
                                new Pose2d(inchesToMeters(-175) + xOffset, inchesToMeters(-80) + yOffset,
                                                new Rotation2d(Math.toRadians(0))),
                                // Pass config
                                AutonConfig.getInstance().getReverseConfig());

                // Configure the values of all trajectories for max velocity and acceleration
