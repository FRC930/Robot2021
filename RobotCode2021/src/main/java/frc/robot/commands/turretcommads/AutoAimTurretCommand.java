...
//-------- PIDCOMMAND CLASS --------\\
/**
 * <h4>AutoAimTurretCommand</h4> Tracks the Power Port using the limelight.
 */
public class AutoAimTurretCommand extends PIDCommand {
     ...
     * 
     * @param limelight    instantiated LimelightSubsystem
     * @param turret       instantiated TurretSubsystem
     * @param controller   instantiated controller
     * @param coDriver     instantiated codriver joystick
     * @param coDriverAxis number for the joystick axis needed
     */
    public AutoAimTurretCommand(LimelightSubsystem limelight, TurretSubsystem turret, PIDController controller,
            Joystick coDriver, int coDriverAxis) {
        // Initial P = 0.065
        ...
        super(controller,
                ...
                (double output) -> {
                    ...
                    if (Math.abs(coDriver.getRawAxis(coDriverAxis)) > turret.getJoystickTurretDeadband()) {
