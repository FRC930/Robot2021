...
public class HalfExtendBottomFlywheelPistonCommand extends CommandBase {
  ...
  public HalfExtendBottomFlywheelPistonCommand(FlywheelPistonSubsystem flywheelAngleSubsystem) {
  ...
  public void initialize() {
    ...
    //flywheelAngleSubsystem.setTop(SolenoidValues.RETRACT);
